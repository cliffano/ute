...
Ute.prototype.start = function () {
    ...
    app.configure(function () {
        that.config.configure(app, that.text.getText(), './public/scripts/', ['jquery-min-1.4.2.js', 'json2.js', 'global.js'], './public/styles/', ['grids-min-2.8.1.css', 'global.css']);
        that.error.configure(app);
    });
